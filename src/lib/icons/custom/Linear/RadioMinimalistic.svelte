...
<Icon {...props}>
	...
	<path d="M13.5 11H19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M13.5 14H19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M13.5 17H19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
