...
<Icon {...props}>
	<circle cx="12" cy="10" r="7" stroke="currentColor" stroke-width="1.5" />
	<path
	...
	<path d="M12 22H10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M14 22H12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
</Icon>
