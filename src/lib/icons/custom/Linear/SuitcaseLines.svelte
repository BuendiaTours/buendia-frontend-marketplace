...
<Icon {...props}>
	...
	<path
		...
		stroke-width="1.5"
	/>
	<path d="M2 11L22 11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M2 17L22 17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
</Icon>
