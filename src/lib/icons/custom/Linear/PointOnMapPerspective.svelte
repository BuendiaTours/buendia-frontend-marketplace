...
<Icon {...props}>
	<path
		...
		stroke-width="1.5"
	/>
	<path d="M21 21L3 11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M3.5 21L12 16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<circle cx="17" cy="5" r="3" stroke="currentColor" stroke-width="1.5" />
