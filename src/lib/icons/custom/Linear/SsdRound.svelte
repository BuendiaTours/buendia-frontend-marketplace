...
<Icon {...props}>
	<path
		...
		stroke-width="1.5"
	/>
	<path d="M18 17V18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M15.5 17V18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M13 17V18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M10.5 17V18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
</Icon>
