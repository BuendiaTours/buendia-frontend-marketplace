...
<Icon {...props}>
	<path d="M16.5 7.5L13.5 7.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path
		...
		stroke-width="1.5"
	/>
	<path d="M22 20H14M2 20H10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
