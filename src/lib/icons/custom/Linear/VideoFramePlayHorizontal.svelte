...
<Icon {...props}>
	<path
		...
		stroke-width="1.5"
	/>
	<path d="M21.5 17L2.5 17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M21.5 7L2.5 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path
