...
<Icon {...props}>
	...
	<path
		...
		stroke-width="1.5"
	/>
	<path d="M19 20H17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M11 22H8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M11 22V17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M11 13H2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
</Icon>
