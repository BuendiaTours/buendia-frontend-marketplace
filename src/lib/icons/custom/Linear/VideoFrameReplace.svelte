...
<Icon {...props}>
	...
	<path
		...
		stroke-width="1.5"
	/>
	<path d="M6 2.5V10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M13.5 14.5V22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M11 2.5V10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M17.5 14.5V22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M2.5 6L6 6M15 6L11 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path
