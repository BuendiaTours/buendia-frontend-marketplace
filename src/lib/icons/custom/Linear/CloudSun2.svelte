...
<Icon {...props}>
	...
	<path
		...
		stroke-width="1.5"
	/>
	<path d="M7.5 2V2.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M2.5 7.5L2 7.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path
