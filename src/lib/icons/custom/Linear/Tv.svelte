...
<Icon {...props}>
	<path
		...
		stroke-width="1.5"
	/>
	<path d="M9 2L12 5.5L15 2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M16 6V22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path
