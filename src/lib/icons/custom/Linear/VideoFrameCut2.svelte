...
<Icon {...props}>
	...
	<path d="M12 7.5V8.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M12 15.5V16.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
</Icon>
