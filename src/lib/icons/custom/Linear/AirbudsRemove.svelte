...
<Icon {...props}>
	...
	<path
		...
		stroke-width="1.5"
	/>
	<path d="M19.5 5V7.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M4.5 7V9.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
