...
<Icon {...props}>
	...
	<path
		...
		stroke-width="1.5"
	/>
	<path d="M16.9585 9L16.9585 2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M6.9585 15L6.9585 22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path
	...
	/>
	<path d="M6.9585 2L6.9585 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
</Icon>
