...
<Icon {...props}>
	...
	<path
		...
		stroke-width="1.5"
	/>
	<path d="M13.5 6L18 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M6 7L6 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M9 7L9 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M13.5 17H18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M6 18L6 16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
	<path d="M9 18L9 16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
</Icon>
