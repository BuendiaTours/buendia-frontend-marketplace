...
<Icon iconName="Linear.Mirror2" {...props}>
	<path d="M4.35 17C3.49422 15.597 3 13.9413 3 12.168C3 7.10468 7.02944 3 12 3C16.9706 3 21 7.10468 21 12.168C21 13.9413 20.5058 15.597 19.65 17" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
