...
<Icon iconName="Linear.Logout3" {...props}>
...
<path d="M15 12L6 12M6 12L8 14M6 12L8 10" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round" stroke-linejoin="round"/>
</Icon>
