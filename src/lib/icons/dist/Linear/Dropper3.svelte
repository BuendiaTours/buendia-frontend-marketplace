...
<Icon iconName="Linear.Dropper3" {...props}>
	...
	/>
	<path
		d="M18 11.4166C18 12.5672 17.1046 13.4999 16 13.4999C14.8954 13.4999 14 12.5672 14 11.4166C14 10.6967 14.783 9.73582 15.3691 9.11737C15.7161 8.75124 16.2839 8.75124 16.6309 9.11737C17.217 9.73582 18 10.6967 18 11.4166Z"
		stroke="currentColor"
		stroke-width="var(--icon-stroke-width)"
	/>
	<path
