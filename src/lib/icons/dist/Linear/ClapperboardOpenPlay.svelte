...
<Icon iconName="Linear.ClapperboardOpenPlay" {...props}>
	<path
	...
	/>
	<path
		d="M8.42209 4.62396L7.78433 9.97123"
		stroke="currentColor"
		stroke-width="var(--icon-stroke-width)"
		stroke-linecap="round"
	/>
