...
<Icon iconName="Linear.SliderVerticalMinimalistic" {...props}>
...
<path d="M21 4.5L21 19.5" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
<path d="M3 4.5L3 19.5" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
</Icon>
