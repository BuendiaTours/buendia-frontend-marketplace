...
<Icon iconName="Linear.SquareAltArrowLeft" {...props}>
	<path d="M13.5 9L10.5 12L13.5 15" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round" stroke-linejoin="round"/>
