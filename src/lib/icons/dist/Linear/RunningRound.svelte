...
<Icon iconName="Linear.RunningRound" {...props}>
	<circle cx="18.5" cy="4.5" r="2.5" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
...
<path d="M9 17L8.74064 17.3112C7.32089 19.0149 5.21773 20 3 20" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
<path d="M16 12C17.3131 12.3283 18.6869 12.3283 20 12" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
</Icon>
