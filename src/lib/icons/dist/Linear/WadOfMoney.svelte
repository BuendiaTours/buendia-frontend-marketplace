...
<Icon iconName="Linear.WadOfMoney" {...props}>
...
<path d="M9 9C7.34315 9 6 10.3431 6 12C6 13.6569 7.34315 15 9 15" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
<path d="M15 9C16.6569 9 18 10.3431 18 12C18 13.6569 16.6569 15 15 15" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
<path d="M9 5V18.5" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
<path d="M15 5V18.5" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
</Icon>
