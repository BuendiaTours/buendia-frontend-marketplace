...
<Icon iconName="Linear.CameraMinimalistic" {...props}>
	<circle cx="12" cy="13" r="3" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
...
<path d="M18 10H17.5" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
<path d="M15 3H9" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
</Icon>
