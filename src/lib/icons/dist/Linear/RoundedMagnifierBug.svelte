...
<Icon iconName="Linear.RoundedMagnifierBug" {...props}>
	<circle cx="11" cy="11" r="9" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
<path d="M11 15C9.34315 15 8 13.6569 8 12V10M11 15C12.6569 15 14 13.6569 14 12V10M11 15V10M14 10C14 8.34315 12.6569 7 11 7C9.34315 7 8 8.34315 8 10M14 10H8M14.0715 11H15.5M6.5 11H8M14 13.5L15 14M8 13.5L7 14M14 8.5L15 8M8 8.5L7 8" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
