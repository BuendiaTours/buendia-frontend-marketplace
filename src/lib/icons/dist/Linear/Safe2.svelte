...
<Icon iconName="Linear.Safe2" {...props}>
...
<path d="M8 12C8 9.79086 9.79086 8 12 8C14.2091 8 16 9.79086 16 12C16 14.2091 14.2091 16 12 16C9.79086 16 8 14.2091 8 12Z" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
...
<path d="M12 12V8" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
<path d="M12 12L15.5 13.5" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
<path d="M12 12L8.5 13.5" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
<path d="M4.5 7V10" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
<path d="M4.5 14V17" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
</Icon>
