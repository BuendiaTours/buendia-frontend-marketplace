...
<Icon iconName="Linear.CloudSnowfall" {...props}>
...
<path d="M12.001 15V22" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
<path d="M9.00293 16.7314L15.0016 20.1948" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
<path d="M14.999 16.7314L9.00031 20.1948" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
</Icon>
