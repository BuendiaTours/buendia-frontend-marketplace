...
<Icon iconName="Linear.CloudBoltMinimalistic" {...props}>
...
<path d="M10 22.0002L14.2857 18.3078H10L14.2857 14.6152" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round" stroke-linejoin="round"/>
</Icon>
