...
<Icon iconName="Linear.LightbulbMinimalistic" {...props}>
	<path d="M10 19.5H14M10.6667 22H13.3333" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
