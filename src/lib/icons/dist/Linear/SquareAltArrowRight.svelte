...
<Icon iconName="Linear.SquareAltArrowRight" {...props}>
	<path d="M10.5 9L13.5 12L10.5 15" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round" stroke-linejoin="round"/>
