...
<Icon iconName="Linear.SliderMinimalisticHorizontal" {...props}>
...
<path d="M4.5 3L19.5 3" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
<path d="M4.5 21L19.5 21" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
</Icon>
