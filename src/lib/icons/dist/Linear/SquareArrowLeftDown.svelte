...
<Icon iconName="Linear.SquareArrowLeftDown" {...props}>
	<path d="M15 9L9 15M9 15L9 10.5M9 15L13.5 15" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round" stroke-linejoin="round"/>
