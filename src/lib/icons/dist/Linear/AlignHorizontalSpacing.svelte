...
<Icon iconName="Linear.AlignHorizontalSpacing" {...props}>
	<path d="M3 2L3 22" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
<path d="M21 2L21 22" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
