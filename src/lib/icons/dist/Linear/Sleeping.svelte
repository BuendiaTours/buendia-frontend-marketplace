...
<Icon iconName="Linear.Sleeping" {...props}>
	<path d="M2 6V18" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round" stroke-linejoin="round"/>
...
<path d="M9.5 11C9.5 12.3807 8.38071 13.5 7 13.5C5.61929 13.5 4.5 12.3807 4.5 11C4.5 9.61929 5.61929 8.5 7 8.5C8.38071 8.5 9.5 9.61929 9.5 11Z" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
</Icon>
