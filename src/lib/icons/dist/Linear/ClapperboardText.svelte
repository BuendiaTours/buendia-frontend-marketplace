...
<Icon iconName="Linear.ClapperboardText" {...props}>
...
<path d="M17 2.5L13.5 8" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
<path d="M6.5 14H14.5" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
<path d="M6.5 17.5H12" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
</Icon>
