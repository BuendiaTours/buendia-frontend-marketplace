...
<Icon iconName="Linear.AirbudsCase" {...props}>
...
<path d="M7 9C7 7.89543 7.89543 7 9 7H15C16.1046 7 17 7.89543 17 9C17 10.1046 16.1046 11 15 11H9C7.89543 11 7 10.1046 7 9Z" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
<path d="M21 9H17.5M7 9H3" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
</Icon>
