...
<Icon iconName="Linear.Bacteria" {...props}>
	...
	/>
	<path
		d="M14.4648 7.17122C14.4648 7.17122 15.7077 6.99983 16.5862 7.87832C17.4647 8.75682 17.2933 9.99964 17.2933 9.99964"
		stroke="currentColor"
		stroke-width="var(--icon-stroke-width)"
		stroke-linecap="round"
	/>
	<path
		d="M9.00013 9.29278C9.00013 9.29278 7.7573 9.46417 6.87881 8.58568C6.00032 7.70718 6.1717 6.46436 6.1717 6.46436"
		stroke="currentColor"
		stroke-width="var(--icon-stroke-width)"
		stroke-linecap="round"
	/>
