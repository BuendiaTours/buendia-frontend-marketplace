...
<Icon iconName="Linear.Display" {...props}>
...
<path d="M12 19V16.5M12 19L18 21M12 19L6 21" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
</Icon>
