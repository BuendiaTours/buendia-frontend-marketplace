...
<Icon iconName="Linear.SquareArrowDown" {...props}>
	<path d="M12 8L12 16M12 16L15 13M12 16L9 13" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round" stroke-linejoin="round"/>
