...
<Icon iconName="Linear.MinimizeSquare3" {...props}>
...
<path d="M17 7L12 12M12 12H15.75M12 12V8.25" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round" stroke-linejoin="round"/>
