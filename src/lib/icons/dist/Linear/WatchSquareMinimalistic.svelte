...
<Icon iconName="Linear.WatchSquareMinimalistic" {...props}>
...
<path d="M12 9V12.0769L14 14" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round" stroke-linejoin="round"/>
