...
<Icon iconName="Linear.RoundedMagnifierZoomIn" {...props}>
	<circle cx="11" cy="11" r="9" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
<path d="M9 11H11M11 11H13M11 11V13M11 11V9" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
