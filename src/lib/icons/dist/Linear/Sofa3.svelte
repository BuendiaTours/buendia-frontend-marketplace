...
<Icon iconName="Linear.Sofa3" {...props}>
	<path d="M4 18H20C21.1046 18 22 17.1046 22 16C22 14.8954 21.1046 14 20 14H4C2.89543 14 2 14.8954 2 16C2 17.1046 2.89543 18 4 18Z" stroke="currentColor" stroke-width="var(--icon-stroke-width)"/>
...
<path d="M20 20V18M4 20V18" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
</Icon>
