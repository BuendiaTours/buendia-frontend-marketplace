...
<Icon iconName="Linear.WindowFrame" {...props}>
...
<path d="M2 9.5H22" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
<path d="M9 21L9 10" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
</Icon>
