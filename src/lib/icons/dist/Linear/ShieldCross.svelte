...
<Icon iconName="Linear.ShieldCross" {...props}>
...
<path d="M14.5 9.5L9.50002 14.5M9.5 9.49998L14.5 14.5" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round"/>
</Icon>
