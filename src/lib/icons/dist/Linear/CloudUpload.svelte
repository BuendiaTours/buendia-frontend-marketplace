...
<Icon iconName="Linear.CloudUpload" {...props}>
...
<path d="M12 16V22M12 16L14 18M12 16L10 18" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round" stroke-linejoin="round"/>
</Icon>
