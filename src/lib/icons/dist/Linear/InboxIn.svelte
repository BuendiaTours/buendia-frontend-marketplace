...
<Icon iconName="Linear.InboxIn" {...props}>
	<path d="M12 2L12 10M12 10L15 7M12 10L9 7" stroke="currentColor" stroke-width="var(--icon-stroke-width)" stroke-linecap="round" stroke-linejoin="round"/>
