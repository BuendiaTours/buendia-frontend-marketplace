...
<details class="c-faq-item py-4">
	...
	{#if answer}
		<div
			class="p-base-editorial pt-2 text-neutral-700 [&_a]:text-neutral-700 [&_a]:underline [&_a]:underline-offset-4 [&_a:hover]:text-neutral-900 [&_p:not(:last-child)]:pb-2 [$_a]:font-bold"
		>
