...
<footer class="footer-center footer bg-neutral text-neutral-content p-10">
	<aside>
		<p class="font-bold">
			Tu Empresa
			<br />
			Proporcionando experiencias increíbles desde 2020
		</p>
	...
	<nav>
		<div class="grid grid-flow-col gap-4">
			...
			<a href="/terms" class="link link-hover">Términos</a>
		</div>
	</nav>
</footer>
